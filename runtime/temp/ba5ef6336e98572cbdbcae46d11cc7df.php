			...
			<div class="classify-screen-con">
				<div class="classify-choose">
					<?php if($shop_group_id == ''): ?>
						<a target="_self" href="SHOP_MAIN/shop/shopstreet" class="selected">
						<span>全部</span>
					</a>
					<?php else: ?>
						<a target="_self" href="SHOP_MAIN/shop/shopstreet" >
							<span>全部</span>
						</a>
					<?php endif; foreach($shop_group_list as $vo): if($vo['shop_group_id'] == $shop_group_id): ?>
							<a target="_self" href="SHOP_MAIN/shop/shopstreet?shop_group_id=<?php echo $vo['shop_group_id']; ?>" title="<?php echo $vo['group_name']; ?>" class="selected">
								<span><?php echo $vo['group_name']; ?></span>
							</a>
						<?php else: ?>
							  <a target="_self" href="SHOP_MAIN/shop/shopstreet?shop_group_id=<?php echo $vo['shop_group_id']; ?>" title="<?php echo $vo['group_name']; ?>">
								<span><?php echo $vo['group_name']; ?></span>
							</a>
						<?php endif; endforeach; ?>
				</div>
...
<div class="w1210">
	<div id="filter">
		<form method="get" name="listform" id="listform" action="SHOP_MAIN/shop/shopstreet">
			<div class="fore1">
				<dl class="order">
					<!-- 默认 -->
					<?php if($order_type == ''): ?>
					...
					<?php else: ?>
						<dd class="first">
					<?php endif; ?>
					<a href="SHOP_MAIN/shop/shopstreet?shop_group_id=<?php echo $shop_group_id; ?>&shop_name=<?php echo $shop_name; ?>&order_type="> 默认 </a>
						</dd>
					...
					<?php endif; if($sort == 'desc'): ?>
						<a href="SHOP_MAIN/shop/shopstreet?shop_group_id=<?php echo $shop_group_id; ?>&shop_name=<?php echo $shop_name; ?>&order_type=1&sort=asc">销量<b class="icon-order-DESCending"></b></a>
					<?php else: ?>
						<a href="SHOP_MAIN/shop/shopstreet?shop_group_id=<?php echo $shop_group_id; ?>&shop_name=<?php echo $shop_name; ?>&order_type=1&sort=desc">销量
							<?php if($order_type == 1): ?>
					...
					<?php else: ?>
						<dd class="">
					<?php endif; if($sort == 'desc'): ?>
						<a href="SHOP_MAIN/shop/shopstreet?shop_group_id=<?php echo $shop_group_id; ?>&shop_name=<?php echo $shop_name; ?>&order_type=2&sort=asc">信誉<b class="icon-order-DESCending"></b></a>
						<?php else: ?>
						<a href="SHOP_MAIN/shop/shopstreet?shop_group_id=<?php echo $shop_group_id; ?>&shop_name=<?php echo $shop_name; ?>&order_type=2&sort=desc">信誉
								<?php if($order_type == 2): ?>
									<b class="icon-order-ASCending"></b>
								<?php else: ?>
									<b class="icon-order-DESCending"></b>
	...
	<div class="main" id="table_list">
		...
		<?php else: ?>
			...
			<?php if(is_array($shop_list) || $shop_list instanceof \think\Collection || $shop_list instanceof \think\Paginator): if( count($shop_list)==0 ) : echo "" ;else: foreach($shop_list as $key=>$vo): ?>
				<li><a href="SHOP_MAIN/shop/shopindex?shop_id=<?php echo $vo['shop_id']; ?>" target="_blank" title="<?php echo $vo['shop_name']; ?>">
...
<div id="pagination" class="page" >
	...
	<div class="page-num fr">
		...
		<div id="page_list" style="float: left;<?php echo $path_info; ?>">
			...
			<!-- 总页数小于总页码时就都显示 -->
			<?php if($page_count <= $page_num): $__FOR_START_4875__=1;$__FOR_END_4875__=$page_count+1;for($i=$__FOR_START_4875__;$i < $__FOR_END_4875__;$i+=1){ if($i == $page): ?>
			...
			<?php elseif($page <= ($page_num-1)/2): $__FOR_START_17114__=1;$__FOR_END_17114__=$page_num+1;for($i=$__FOR_START_17114__;$i < $__FOR_END_17114__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="SHOP_MAIN/<?php echo $path_info; ?>?page=<?php echo $i; ?><?php echo $query_string; ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 如果总页数等于当前页 或者 总页数小于当前页加上页码总数平均值显示 -->
			<?php elseif($page_count == $page or $page_count <= $page+($page_num-1)/2): $__FOR_START_9349__=$page_count-$page_num+1;$__FOR_END_9349__=$page_count+1;for($i=$__FOR_START_9349__;$i < $__FOR_END_9349__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="SHOP_MAIN/<?php echo $path_info; ?>?page=<?php echo $i; ?><?php echo $query_string; ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 否则就正常显示 -->
			<?php else: $__FOR_START_9724__=$page-($page_num-1)/2;$__FOR_END_9724__=$page+($page_num-1)/2+1;for($i=$__FOR_START_9724__;$i < $__FOR_END_9724__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="SHOP_MAIN/<?php echo $path_info; ?>?page=<?php echo $i; ?><?php echo $query_string; ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } endif; ?>
