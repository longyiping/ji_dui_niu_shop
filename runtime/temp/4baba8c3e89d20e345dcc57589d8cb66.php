	...
	<div class="member-main" >
		<div class="box">
			...
			<div class="member-data-header">
				...
				<div class="common-btn" onclick="recharge();" style="float:right;">余额充值</div>
			</div>
			<?php if($total_count != ''): ?>
			<table>
				<tr align="center">
				...
				<tbody id="list_content" class="close-order">
					...
					<tr align="center">
						...
						<td><?php echo $balance['create_time']; ?></td>
					</tr>
					<?php endforeach; ?>
				</tbody>
			</table>
...
<div id="pagination" class="page" >
	...
	<div class="page-num fr">
		...
		<div id="page_list" style="float: left;<?php echo $path_info; ?>">
			...
			<!-- 总页数小于总页码时就都显示 -->
			<?php if($page_count <= $page_num): $__FOR_START_14406__=1;$__FOR_END_14406__=$page_count+1;for($i=$__FOR_START_14406__;$i < $__FOR_END_14406__;$i+=1){ if($i == $page): ?>
			...
			<?php elseif($page <= ($page_num-1)/2): $__FOR_START_7201__=1;$__FOR_END_7201__=$page_num+1;for($i=$__FOR_START_7201__;$i < $__FOR_END_7201__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="SHOP_MAIN/<?php echo $path_info; ?>?page=<?php echo $i; ?><?php echo $query_string; ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 如果总页数等于当前页 或者 总页数小于当前页加上页码总数平均值显示 -->
			<?php elseif($page_count == $page or $page_count <= $page+($page_num-1)/2): $__FOR_START_2696__=$page_count-$page_num+1;$__FOR_END_2696__=$page_count+1;for($i=$__FOR_START_2696__;$i < $__FOR_END_2696__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="SHOP_MAIN/<?php echo $path_info; ?>?page=<?php echo $i; ?><?php echo $query_string; ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 否则就正常显示 -->
			<?php else: $__FOR_START_9771__=$page-($page_num-1)/2;$__FOR_END_9771__=$page+($page_num-1)/2+1;for($i=$__FOR_START_9771__;$i < $__FOR_END_9771__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="SHOP_MAIN/<?php echo $path_info; ?>?page=<?php echo $i; ?><?php echo $query_string; ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } endif; ?>
