...
<div id="pagination" class="page" >
	...
	<div class="page-num fr">
		...
		<div id="page_list" style="float: left;<?php echo $path_info; ?>">
			...
			<!-- 总页数小于总页码时就都显示 -->
			<?php if($page_count <= $page_num): $__FOR_START_11246__=1;$__FOR_END_11246__=$page_count+1;for($i=$__FOR_START_11246__;$i < $__FOR_END_11246__;$i+=1){ if($i == $page): ?>
			...
			<?php elseif($page <= ($page_num-1)/2): $__FOR_START_30057__=1;$__FOR_END_30057__=$page_num+1;for($i=$__FOR_START_30057__;$i < $__FOR_END_30057__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="SHOP_MAIN/<?php echo $path_info; ?>?page=<?php echo $i; ?><?php echo $query_string; ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 如果总页数等于当前页 或者 总页数小于当前页加上页码总数平均值显示 -->
			<?php elseif($page_count == $page or $page_count <= $page+($page_num-1)/2): $__FOR_START_23536__=$page_count-$page_num+1;$__FOR_END_23536__=$page_count+1;for($i=$__FOR_START_23536__;$i < $__FOR_END_23536__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="SHOP_MAIN/<?php echo $path_info; ?>?page=<?php echo $i; ?><?php echo $query_string; ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 否则就正常显示 -->
			<?php else: $__FOR_START_15411__=$page-($page_num-1)/2;$__FOR_END_15411__=$page+($page_num-1)/2+1;for($i=$__FOR_START_15411__;$i < $__FOR_END_15411__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="SHOP_MAIN/<?php echo $path_info; ?>?page=<?php echo $i; ?><?php echo $query_string; ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } endif; ?>
