				...
				<div id="tab_tab1_1">
					...
					<ul class="bonus_con">
						...
						<li>
							<p class="bonus_con_1">
								<strong>￥</strong>
								<span class="type_money"><?php echo $vo['money']; ?></span>
								<span class="bonus_status"><?php echo $vo['state']; ?></span>
							</p>
							<p>发行店铺：<a href="#"><?php echo $vo['shop_id']; ?></a></p>
							<p>优惠券编码：<?php echo $vo['coupon_code']; ?></p>
							<p>有效时间：截至<?php echo $vo['end_time']; ?></p>
						</li>
						<?php endforeach; endif; else: echo "" ;endif; ?>
					</ul>
					<?php else: ?>
