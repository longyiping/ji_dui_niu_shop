	...
	<div class="flowBox_jm">
		<div class="title_jm">
			<table cellpadding="0" cellspacing="0" width="100%" border="0">
				<tbody>
					<tr>
						<td width="8%" align="center"><input type="checkbox" autocomplete="off" id="chkAll" name="chkAll" checked="true" onclick="return chkAll_onclick()" style="height:28px;vertical-align:middle;">全选</td>
		...
		<form id="formCart" name="formCart" method="post" action="">
			<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $i=>$cart): ?>
				...
				<tbody>
					<tr height="35">
						<td style="text-indent:19px; background:#FAFAFA;font-weight:bold;color:#E31939">
							<?php $a= explode(",",$i); echo $a[1];?>
						</td>
					</tr>
				</tbody>
			</table>
			<?php if(is_array($cart) || $cart instanceof \think\Collection || $cart instanceof \think\Paginator): if( count($cart)==0 ) : echo "" ;else: foreach($cart as $k=>$cart_info): ?>
			<table align="center" cellpadding="0" cellspacing="0" style="height:auto;width:100%;">
				<tbody>
					<tr>
									...
									<tr>
											...
											<div class="thumb_name">
												<dl>
													<dt> 
														...
														<img src="__UPLOAD__/<?php echo $cart_info['picture_info']['pic_cover_small']; ?>" border="0" title="<?php echo $cart_info['goods_name']; ?>"></a>
													</dt>
													<dd>
														<a href="SHOP_MAIN/goods/goodsinfo?goodsid=<?php echo $cart_info['goods_id']; ?>" target="_blank" class="f6"><?php echo $cart_info['goods_name']; ?></a>
														<br>
										...
										<td align="center" width="15%">
											...
											￥<?php echo $cart_info['price']; if($cart_info['point_exchange_type']==1): if($cart_info['point_exchange']>0): ?>
												+<?php echo $cart_info['point_exchange']; ?>积分
												<?php endif; ?>
<!-- 												<br/>积分商品 -->
											<?php endif; ?>
											</font>
										...
										<td align="center" width="10%">
											<a href="javascript:deleteShoppingCartById(<?php echo $cart_info['cart_id']; ?>,true)" class="f6">删除</a>
										</td>
									</tr>
								</tbody>
							</table>
		...
		<table width="100%" align="center" border="0" cellpadding="5" cellspacing="6" style="border-top:1px solid #eee;">
			<tbody>
				<tr>
					<td width="150">
						<a href="SHOP_MAIN" class="continue_buy">继续购物</a>
					</td>
		...
		<div class="cart-empty">
			<div class="message">
				<ul>
					...
					<li><a href="SHOP_MAIN" class="btn-link" title="去购物">去购物&gt;</a></li>
				</ul>
			</div>
		</div>
	</div>
