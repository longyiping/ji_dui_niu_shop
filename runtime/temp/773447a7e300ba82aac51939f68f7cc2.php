		...
		<div class="box"> 
			...
			<div class="ncm-user-profile">
						...
						<table cellpadding="10" width="600px">
							<tr>
								...
								<td width="65%" align="left">
									<?php if($member_img != '' and $member_img != '0'): ?>
									<img src="__UPLOAD__/<?php echo $member_img; ?>" width="120px" height="120px" onClick="setTabCatGoods('tab',2,3)"/>
									<?php else: ?>
									<img src="__TEMP__/<?php echo $style; ?>/public/images/temp_default_user_portrait_0.png" width="120px" height="120px" />
									<?php endif; ?>
									<span></span>
								</td>
							</tr>
				...
				<div class="ncm-default-form" id="con_tab_2" style="display:none; color:red">
					<form name="formEdit2" action="SHOP_MAIN/member/person" method="post" enctype="multipart/form-data" onsubmit="return isOk();">
							...
							<tr>
								<td colspan="2" align="center">
									<div class="img" id="preview">
										<?php if($member_img != '' and $member_img != '0'): ?>
										<img src="__UPLOAD__/<?php echo $member_img; ?>" width="120px" height="120px"/>
										<?php else: ?>
