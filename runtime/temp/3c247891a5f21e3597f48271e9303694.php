...
$(function(){
	...
	<div class="member-main">
		...
		<div class="box">
			<div class="tabmenu">
				<ul class="tab">
					<li class="active">对商品进行追加评价</li>
				</ul>
			</div>
			<a href="javascript:history.go(-1);" style="position: absolute;right: 10px;top: 20px;">返&nbsp;回</a>
			<div class="evaluate_main">
				<form id="evalform" method="post" action="SHOP_MAIN/member/moditycommodity">
					...
					<div class="evaluate_block">
						<h4>操作提示：</h4>
						<ul>
							<li style="margin-bottom: 6px; float:none;">评价信息最多填写150字，请您根据本次交易，给予真实、客观地评价；您的评价将是其他会员的参考。</li>
							<li style="margin-bottom: 6px; float:none;">店铺动态评分默认为“5分”，您可以根据本次交易情况给予商家评分，<span class="orange"> 一旦提交后不能修改。</span></li>
						</ul>
					</div>
					<div class="tabmenu2">
						<ul class="tab" style="border-bottom: solid 1px #E7E7E7;">
							<li class="active" style="float:none"><a href="javascript:void(0);" style="font-size:16px; font-weight: 600; text-decoration: none; color: #0689e1; padding: 7px 19px 9px 19px;border-bottom: solid 2px #0689e1; cursor: default;">对购买过的商品评价</a></li>
						</ul>
					</div>
					...
					<div class="evaluate" ogid="<?php echo $vo['order_goods_id']; ?>" oid="<?php echo $vo['order_id']; ?>">
						<div class="evaluate_left">
							<div class="evaluate_left_top">
								<img src="__UPLOAD__/<?php echo $vo['picture_info']['pic_cover_small']; ?>" />
							</div>
						...
						<!-- <div class="item-rate-act">
							...
							<div>
								<div class="evaluate_right_one star">商品评分：
							...
							<div class="rate_content">
								<textarea cols="60" rows="4" placeholder="请输入要评价的内容，不要超过150个字符。" style="resize: none;"></textarea>
								<span class="evaluate_right_two"> 
									<input type='file' class="input-file" name='imgPhoto' id="img_<?php echo $vo['order_goods_id']; ?>" onchange='UploadImage(this);' />
								</span>
								<span class="evaluate_right_three"><i></i>买家晒图</span>
								<span class="evaluate_right_imgs"></span>
								<span class="evaluate_right_four">0/5</span>
								<span class="evaluate_right_isni"><label> <input type="checkbox" id="checkbox<?php echo $vo['order_goods_id']; ?>" class="checkbox vm">&nbsp;匿名评价</label></span>
							</div>
						</div>
					</div>
					<?php endforeach; ?>
					<div class="evaluate_form">
						<div class="evaluate_bottom">
							<input id="btn_submit" type="button" class="common-btn" onclick="doSubmit(1)" value="提交"/>
						</div>
					</div>
				</form>
...
$(function(){
	...
	$(".js-bread-crumb").parent().append('<span class="crumbs-arrow">&gt;</span><a href="SHOP_MAIN/member/reviewCommodity?orderid=<?php echo $order_id; ?>">商品评价</a>');
});
</script>
