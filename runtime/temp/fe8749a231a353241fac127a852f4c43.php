...
<link rel="stylesheet" type="text/css" href="__TEMP__/<?php echo $style; ?>/public/css/integralcenter/exchange.css">
<style type="text/css">
...
<div class="margin-w1210 clearfix">
	<div class="w">
		<div class="breadcrumb clearfix">
			...
			<a href="SHOP_MAIN/goods/integralcenter" class="last">积分商城</a>
		</div>
	</div>
	<div class="blank"></div>
	...
	<div class="spot-goods fr">
		...
		<ul id="JS_spot_goods">
			...
			<li <?php if($k == 0): ?>class="open"<?php endif; ?>>
				<div class="show">
					<span class="index"><?php echo $k+1; ?></span>
					<a href="SHOP_MAIN/goods/goodsinfo?goodsid=<?php echo $good['goods_id']; ?>" target="_blank" title="<?php echo $good['goods_name']; ?>"><?php echo $good['goods_name']; ?></a>
					<span class="price red">积分：<?php echo $good['point_exchange']; ?></span>
				</div>
				<div class="hide">
					<div class="title">
						<span class="index"><?php echo $k+1; ?></span>
					...
					<div class="detail">
						<a href="" target="_blank" title="<?php echo $good['goods_name']; ?>" class="img">
							<img src="__UPLOAD__/<?php echo $good['pic_cover_micro']; ?>" width="122" height="122" alt="<?php echo $good['goods_name']; ?>">
						</a>
						<div class="number">
							<p class="p1"><strong>积分：<?php echo $good['point_exchange']; ?></strong></p>
							<p class="p2"><a href="SHOP_MAIN/goods/goodsinfo?goodsid=<?php echo $good['goods_id']; ?>" target="_blank">立即兑换</a></p>
						</div>
					</div>
				</div>
			</li>
		...
		<form method="GET" class="sort" name="listform">
			<div id="filter">
				<div class="fore1" style="border:none;">
					<dl class="order">
						<dt>商品排序：</dt>
						<dd><a <?php if($id == 1): ?>style="color:#0D84D4;"<?php endif; ?>href="SHOP_MAIN/goods/integralcenter?id=1&nav_id=20">按销售量</a><b></b></dd>
						<dd><a <?php if($id == 2): ?>style="color:#0D84D4;"<?php endif; ?>href="SHOP_MAIN/goods/integralcenter?id=2&nav_id=20">按收藏量</a><b></b></dd>
						<dd><a <?php if($id == 3): ?>style="color:#0D84D4;"<?php endif; ?>href="SHOP_MAIN/goods/integralcenter?id=3&nav_id=20">按评价量</a><b></b></dd>
						<dd><a <?php if($id == 4): ?>style="color:#0D84D4;"<?php endif; ?>href="SHOP_MAIN/goods/integralcenter?id=4&nav_id=20">按分享量</a><b></b></dd>
					</dl>
					<div class='pagin pagin-m'><span class='text'><?php if($page >= 1 && $page <= $page_count): ?><?php echo $page; else: ?>1<?php endif; ?>/<?php echo $page_count; ?></span>
						<?php if($page <= 1): ?>
						<span class="prev-disabled">上一页<b></b></span>
						<?php else: ?>
						<a href="SHOP_MAIN/goods/integralcenter?page=<?php echo $page-1; ?>&id=<?php echo $id; ?>" class="prev" style="border:1px solid #CCC">上一页<b></b></a>
						<?php endif; if($page < $page_count && $page >= 1): ?>
						<a href="SHOP_MAIN/goods/integralcenter?page=<?php echo $page+1; ?>&id=<?php echo $id; ?>" class="prev" style="border:1px solid #CCC">下一页<b></b></a> 
						<?php else: ?>
						<span class="prev-disabled">下一页<b></b></span>
						<?php endif; ?>
					</div>
					<div class="total">
						<span>共<strong><?php echo $hotGoods['total_count']; ?></strong>个商品</span>
					</div>
					<span class="clr"></span>
				</div>
			</div>
		...
		<div class="act-list">
			<form name="compareForm" method="post">
				<ul class="clearfix" id="allgoods">
					<?php foreach($allGoods['data'] as $goods): ?>
					<li class="first">
						<div class="img">
							...
							<p class="absBg"></p>
							<p class="absFg">
								<a href="SHOP_MAIN/goods/goodsinfo?<?php echo $goods['goods_name']; ?>" target="_blank" title="<?php echo $goods['goods_name']; ?>"><?php echo $goods['goods_name']; ?></a>
							</p>
						</div>
						<div class="info">
						<?php if($goods['promotion_price'] != 0 AND $goods['point_exchange'] != 0): ?>
							<div class="price" style="width:143px;color:red;">
								<strong class="main-color arial">¥<?php echo $goods['promotion_price']; ?>+</strong>
								<strong class="main-color arial"><?php echo $goods['point_exchange']; ?></strong>
								<span class="main-color jifen">积分</span>
							</div>
							<?php else: if($goods['promotion_price'] == 0): ?>
							<div class="price" style="width:143px;color:red;">
								<strong class="main-color arial"><?php echo $goods['point_exchange']; ?></strong>
								<span class="main-color jifen">积分</span>
							</div>
							...
							<?php endif; endif; ?>
							<div class="discount">
								<span class="f16 yahei"><a href="SHOP_MAIN/goods/goodsinfo?goodsid=<?php echo $goods['goods_id']; ?>" target="_blank">立即兑换</a></span>
							</div>
						</div>
					</li>
					<?php endforeach; ?>
...
<div id="pagination" class="page" >
	...
	<div class="page-num fr">
		...
		<div id="page_list" style="float: left;<?php echo $path_info; ?>">
			...
			<!-- 总页数小于总页码时就都显示 -->
			<?php if($page_count <= $page_num): $__FOR_START_30447__=1;$__FOR_END_30447__=$page_count+1;for($i=$__FOR_START_30447__;$i < $__FOR_END_30447__;$i+=1){ if($i == $page): ?>
			...
			<?php elseif($page <= ($page_num-1)/2): $__FOR_START_30670__=1;$__FOR_END_30670__=$page_num+1;for($i=$__FOR_START_30670__;$i < $__FOR_END_30670__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="SHOP_MAIN/<?php echo $path_info; ?>?page=<?php echo $i; ?><?php echo $query_string; ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 如果总页数等于当前页 或者 总页数小于当前页加上页码总数平均值显示 -->
			<?php elseif($page_count == $page or $page_count <= $page+($page_num-1)/2): $__FOR_START_1225__=$page_count-$page_num+1;$__FOR_END_1225__=$page_count+1;for($i=$__FOR_START_1225__;$i < $__FOR_END_1225__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="SHOP_MAIN/<?php echo $path_info; ?>?page=<?php echo $i; ?><?php echo $query_string; ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 否则就正常显示 -->
			<?php else: $__FOR_START_3280__=$page-($page_num-1)/2;$__FOR_END_3280__=$page+($page_num-1)/2+1;for($i=$__FOR_START_3280__;$i < $__FOR_END_3280__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="SHOP_MAIN/<?php echo $path_info; ?>?page=<?php echo $i; ?><?php echo $query_string; ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } endif; ?>
...
$(document).ready(function(){
	...
	if(data != ''){
		...
		for(i=0;i<data.length;i++){
			str += '<td> <table cellpadding="0" cellspacing="0"><tbody><tr><td><a href="'+data[i]['adv_url']+'" target="_blank"><img src="__UPLOAD__/'+data[i]['adv_image']+'" width="910" height="320" border="0"></a></td></tr></tbody></table> </td>';
		}
		str+="</tr>"
	}
	...
	var str2 = "";
	if(data2 != ''){
		str2 += '<tr><td><a href="'+data2[0]['adv_url']+'" target="_blank"><img src="__UPLOAD__/'+data2[0]['adv_image']+'" width="1210" height="60" border="0"></a></td></tr>"';
		$("#googlebbb").html(str2);
	}
...
<script src="__TEMP__/<?php echo $style; ?>/public/js/integralcenter/integralcenter.js"></script>
<script>
getMemberInfo();
</script>
