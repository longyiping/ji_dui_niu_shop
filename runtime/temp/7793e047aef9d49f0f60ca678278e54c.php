...
.control_integral{height:400px;}
.member-main .tabmenu .tab li.active {
    margin-left: 10px;
}
.platform {
    margin-left: 10px;
   	...
   	<div class="box">
          ...
          <?php if($market_isset == true): foreach($integral['data'] as $integral_list): if($integral_list['shop_id'] == 0): ?>
          	<div class="platform">
          				<div class="shop_point">
	         	 				<span><?php echo $integral_list['point']; ?></span>
	         	 		</div>
	         	 		<div class="shop_img">
							<img  src="__TEMP__/<?php echo $style; ?>/public/images/default/default_shop_avatar.png" />
	         	 		</div>         	 			
         	 			<div class="shop_name">
         	 				<span title="<?php echo $platform_shopname; ?>"><?php echo $platform_shopname; ?></span>
         	 			</div>         	 			
	        </div>	
	        <div class="platform_list">
	        	<span class="integral_back"><a href="SHOP_MAIN/member/integrallist?shop_id=<?php echo $integral_list['shop_id']; ?>" style="color:#fff">积分明细</a></span> 
	       	</div>      
          ...
          <div class="tabmenu" style="margin-bottom:0px; margin-top:15px;">
           ...
           <div class="integral_shop">
         	...
         	<?php if($shop_isset == true): foreach($integral['data'] as $integral_list): if($integral_list['shop_id'] != 0): ?>
	         	<div class="integral_list">
	         	 		...
	         	 		<div class="shop_info">
							...
							<img src="__UPLOAD__/<?php echo $integral_list['extra']['shop_logo']; ?>"/>
						    <?php else: ?>
							<img  src="__TEMP__/<?php echo $style; ?>/public/images/default/default_shop_avatar.png"  />
						    <?php endif; ?>
	         	 			</div>
	         	 			<div class="shop_name">
	         	 				<span title="<?php echo $integral_list['extra']['shop_name']; ?>"><?php echo $integral_list['extra']['shop_name']; ?></span>	         	 				
	         	 			</div>		
	         	 		</div>
	         	 		<div class="shop_block">
	         	 			<span class="integral_back"><a href="SHOP_MAIN/member/integrallist?shop_id=<?php echo $integral_list['shop_id']; ?>" >积分明细</a></span> 
	         	 		</div>	         	 		
	         	</div>	             	 		
	         	<?php endif; endforeach; else: ?>
	       		  没有数据
