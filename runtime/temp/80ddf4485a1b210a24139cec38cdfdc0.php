		...
		<div class="box">
			...
			<div class="member-data-header">
				<span class="member-data-title">
					...
					<span class="sum">(余额:<?php echo $sum; ?>)</span>
				</span>
				<div class="common-btn" onclick="location.href='SHOP_MAIN/member/balancewithdrawals';" style="float:right;">余额提现</div>
			</div>
			<?php if($total_count != ''): ?>
			<table>
				<tr align="center">
				...
				<tbody id="list_content" class="close-order">
					...
					<tr align="center">
						...
						<td><?php echo $balance['ask_for_date']; ?></td>
...
<div id="pagination" class="page" >
	...
	<div class="page-num fr">
		...
		<div id="page_list" style="float: left;<?php echo $path_info; ?>">
			...
			<!-- 总页数小于总页码时就都显示 -->
			<?php if($page_count <= $page_num): $__FOR_START_11865__=1;$__FOR_END_11865__=$page_count+1;for($i=$__FOR_START_11865__;$i < $__FOR_END_11865__;$i+=1){ if($i == $page): ?>
			...
			<?php elseif($page <= ($page_num-1)/2): $__FOR_START_8864__=1;$__FOR_END_8864__=$page_num+1;for($i=$__FOR_START_8864__;$i < $__FOR_END_8864__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="SHOP_MAIN/<?php echo $path_info; ?>?page=<?php echo $i; ?><?php echo $query_string; ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 如果总页数等于当前页 或者 总页数小于当前页加上页码总数平均值显示 -->
			<?php elseif($page_count == $page or $page_count <= $page+($page_num-1)/2): $__FOR_START_12195__=$page_count-$page_num+1;$__FOR_END_12195__=$page_count+1;for($i=$__FOR_START_12195__;$i < $__FOR_END_12195__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="SHOP_MAIN/<?php echo $path_info; ?>?page=<?php echo $i; ?><?php echo $query_string; ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 否则就正常显示 -->
			<?php else: $__FOR_START_4818__=$page-($page_num-1)/2;$__FOR_END_4818__=$page+($page_num-1)/2+1;for($i=$__FOR_START_4818__;$i < $__FOR_END_4818__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="SHOP_MAIN/<?php echo $path_info; ?>?page=<?php echo $i; ?><?php echo $query_string; ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } endif; ?>
...
<?php endif; else: ?>
			<div>
				<div class="emptyFrame"> <i class="user_balance"></i><span>您暂时还没有提现记录哦！</span> </div>
			</div>
			<?php endif; ?>
		</div>
	</div>
