<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:35:"template/shop\blue\Login\email.html";i:1500287002;s:42:"template/shop\blue\Login\registerBase.html";i:1500287000;s:35:"template/shop\blue\loginTopNav.html";i:1500286999;}*/ ?>
<!DOCTYPE html>
		...
		$.ajax({
			...
			success: function(data){
				if(data){
					...
					$.ajax({
						type: "POST",
						url: "SHOP_MAIN/login/sendemailcode",
						...
						<form id="EmailRegisterModel" class="form-horizontal" name="EmailRegisterModel" action="SHOP_MAIN/login/email" method="post">
							...
							<div class="form-group form-group-spe">
								...
								<div class="form-control-box" style="width: 450px;">
									...
									<label class="img" style="margin-left: 5px"> <img class="verifyimg" src=" <?php echo captcha_src(); ?>" onclick="this.src='<?php echo captcha_src(); ?>'"  alt="captcha" style="vertical-align: middle; cursor: pointer; height: 35px;" /> </label>
